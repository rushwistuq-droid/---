...
**はい。** 半径内の在支診・在支病（施設点）が競合として入ります。

| 指標 | 競合の入り方 |
|------|-------------|
| 均衡按分 `equilibrium` | 需要 ÷ (在支診+在支病×ウェイト) |
| 実効按分 `competitive` | 需要 ÷ (在支診×活動率45%+在支病×ウェイト) |
| **獲得KPI** | 実効按分×野心度を、能力・医師FTEで上限 |

能力だけの目標だと院間差が出にくいため、**獲得KPIを本命指標**にしています。

### デモ（獲得KPI）

| 院 | 在支診 | 競合 | 獲得KPI | 伸長 |
|----|--------|------|---------|------|
| リーフシティ市川 | 187 | 低 | 90 | 120 |
| 府中 | 98 | 中 | 70 | 120 |
| ひばりが丘 | 225 | 高 | 45 | 82 |
| 三軒茶屋 | 538 | 高 | 40 | 75 |
